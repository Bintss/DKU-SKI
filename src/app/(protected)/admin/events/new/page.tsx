  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-semibold">행사 등록</h1>
        <a href="/events" className="text-xs text-gray-400 hover:text-gray-600">← 취소</a>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        {/* 설명 */}
        <div>
          <label className="text-xs font-medium text-gray-500 mb-1.5 block">행사 설명</label>
          <textarea
            placeholder="행사에 대한 간단한 설명을 입력해주세요"
            value={description}
